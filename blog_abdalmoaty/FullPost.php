...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <h1 id="myname" class="navbar-brand"> khaled abdalmoaty</h1>
  ...
  <div class="container">
    <div class="row mt-4">
      ...
      <div class="col-sm-8 ">
        ...
        <h1 class="lead">The Complete blog by using PHP by <span id="myname">khaled abdalmoaty</span></h1>
        <?php
        echo ErrorMessage();
        echo SuccessMessage();
        ?>
  ...
  <footer class="bg-dark text-white">
    <div class="container">
      <div class="row">
        <div class="col">
          <p class="lead text-center">Theme By | khaled abdalmoaty | <span id="year"></span> &copy; ----All right Reserved.</p>
        </div>
      </div>
    </div>
  </footer>
